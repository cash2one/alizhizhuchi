...
$(function(){
    ...
    //导航滚动
    $('.nav1 .shouye').click(function(){$('html,body').animate({scrollTop: '0px'}, 800);});
    $('.nav1 .youshi').click(function(){$('html,body').animate({scrollTop:$('#youshi').offset().top}, 800);});
    $('.nav1 .tuandui').click(function(){$('html,body').animate({scrollTop:$('#tuandui').offset().top}, 800);});
    $('.nav1 .moban').click(function(){$('html,body').animate({scrollTop:$('#moban').offset().top}, 800);});
    $('.nav1 .goumai').click(function(){$('html,body').animate({scrollTop:$('#goumai').offset().top}, 800);});
    $('.nav1 .lianxi').click(function(){$('html,body').animate({scrollTop:$('#lianxi').offset().top}, 800);});
    $('.header .goumai').click(function(){$('html,body').animate({scrollTop:$('#goumai').offset().top}, 800);});
