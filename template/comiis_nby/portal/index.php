...
<div class="comiis_main cl">
	<div class="comiis_main_l">
		<div class="comiis_main_l_box cl">
			...
			<div class="comiis_irbox_tits cl">
				<ul>				
					<li class="kmon" id="comiis_db_tab_1" onMouseOver="switchTab('comiis_db_tab',1,2,'kmon');"><a href="#" target="_blank">微资讯</a></li>
					<li id="comiis_db_tab_2" onMouseOver="switchTab('comiis_db_tab',2,2,'kmon');"><a href="#" target="_blank">大播报</a></li>
				</ul>
			</div>
	...
	<div class="comiis_main_r">	
			...
			<div class="comiis_irbox cl">
				<div class="comiis_irbox_tit cl">
					<span><a href="#" target="_blank">更多</a></span><h2>积分商城</h2>
				</div>
			...
			<div class="comiis_irbox cl">
				<div class="comiis_irbox_tit cl">
					<span><a href="#" target="_blank">更多</a></span><h2>nubia学堂</h2>
				</div>
...
<div class="comiis_ibox kmmb0 cl">
	<div class="comiis_ibox_tit cl">
		<span><a href="#" target="_blank">+ 申请友情链接</a></span><h2>友情链接</h2>
	</div>
