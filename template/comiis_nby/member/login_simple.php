		...
		<div class="y pns">
			<table cellspacing="0" cellpadding="0">
				<tr>
					...
					<!--{/if}-->
					<td class="fastlg_l"><label for="ls_cookietime"><input type="checkbox" name="cookietime" id="ls_cookietime" class="pc" value="2592000" tabindex="903" checked="true" />¼Ç ×¡</label></td>
